				...
				<div class="row">
					<div class="span3">
						...
						<div class="room_selector" data-price="34" data-adults="1" data-kids="1">
							<h5><a href="book-start.html#" class="pull-left"><i class="icon-chevron-left"></i></a>Single room<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
						...
						<div class="room_selector" data-price="48"  data-adults="2" data-kids="1" style="display: none;">
							<h5><a href="book-start.html#" class="pull-left "><i class="icon-chevron-left"></i></a>Double Room<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
						...
						<div class="room_selector" data-price="62" data-adults="3" data-kids="2" style="display: none;">
							<h5><a href="book-start.html#" class="pull-left "><i class="icon-chevron-left"></i></a>Triple Room<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
						...
						<div class="room_selector" data-price="72" data-adults="4" data-kids="3" style="display: none;">
							<h5><a href="book-start.html#" class="pull-left "><i class="icon-chevron-left"></i></a>Luxury Room<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
						...
						<div class="room_selector" data-price="97" data-adults="4" data-kids="3" style="display: none;">
							<h5><a href="book-start.html#" class="pull-left "><i class="icon-chevron-left"></i></a>Private pool room<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
						...
						<div class="room_selector" data-price="128" data-adults="5" data-kids="4" style="display: none;">
							<h5><a href="book-start.html#" class="pull-left "><i class="icon-chevron-left"></i></a>Private villa<a href="book-start.html#" class="pull-right "><i class="icon-chevron-right"></i></a></h5>
