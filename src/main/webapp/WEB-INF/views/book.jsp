...
<footer>
	...
	<script type="text/javascript" src="web-resources/js/Script/jquery.js"></script>
	<script type="text/javascript" src="web-resources/js/Script/jquery-ui.js"></script>
	<script type="text/javascript" src="web-resources/js/Script/bootstrap.js"></script>
	<script type="text/javascript" src="web-resources/js/Script/jquery.nivo.slider.js"></script>
	<script type="text/javascript" src="web-resources/js/Script/socialcount.min.js"></script>
	<script src="web-resources/js/jquery.quicksand.js" type="text/javascript"></script>

	<script type="text/javascript" src="web-resources/js/Script/global.js"></script>
</body>
</html>