...
<link rel="stylesheet"
	href="web-resources/css/bootstrap/css/bootstrap.min.css"
	type="text/css">
<link rel="stylesheet"
	href="web-resources/resources/css/bootstrap/css/bootstrap-responsive.min.css"
	type="text/css">
<link rel="stylesheet" href="web-resources/css/hotel.css"
	type="text/css">
<link rel="stylesheet" href="web-resources/css/hotel-responsive.css"
	type="text/css">

<link rel="stylesheet" href="web-resources/js/slider/default.css"
	type="text/css" media="screen" />
<link rel="stylesheet" href="web-resources/css/nivo-slider.css"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="web-resources/css/socialcount-with-icons.css" type="text/css"
	media="screen" />
			...
			<div class="row-fluid home">
				<div class="span3">
					<div class="room_selector" data-price="34" data-adults="1"
						data-kids="1">
						<h5>
							<a href="index.html#" class="pull-left"><i
								class="icon-chevron-left"></i></a>Single room<a href="index.html#"
						...
						<p>All single rooms have one single bed and sleeps one adult.
							A 25-inch TV is included.</p>
					</div>
					<div class="room_selector" data-price="48" data-adults="2"
						data-kids="1" style="display: none;">
						<h5>
							<a href="index.html#" class="pull-left "><i
								class="icon-chevron-left"></i></a>Double Room<a href="index.html#"
								class="pull-right "><i class="icon-chevron-right"></i></a>
						</h5>
						<a href="listings.html"><img
					...
					<div class="room_selector" data-price="62" data-adults="3"
						...
						<h5>
							<a href="index.html#" class="pull-left "><i
								class="icon-chevron-left"></i></a>Triple Room<a href="index.html#"
								class="pull-right "><i class="icon-chevron-right"></i></a>
						</h5>
						<a href="listings.html"><img
					...
					<div class="room_selector" data-price="72" data-adults="4"
						...
						<h5>
							<a href="index.html#" class="pull-left "><i
								class="icon-chevron-left"></i></a>Luxury Room<a href="index.html#"
								class="pull-right "><i class="icon-chevron-right"></i></a>
						</h5>
						<a href="listings.html"><img
					...
					<div class="room_selector" data-price="97" data-adults="4"
						...
						<h5>
							<a href="index.html#" class="pull-left "><i
								...
								href="index.html#" class="pull-right "><i
					...
					<div class="room_selector" data-price="128" data-adults="5"
						...
						<h5>
							<a href="index.html#" class="pull-left "><i
								class="icon-chevron-left"></i></a>Private villa<a href="index.html#"
								class="pull-right "><i class="icon-chevron-right"></i></a>
						</h5>
						<a href="listings.html"><img
		...
		<div class="row-fluid">
			...
			<div class="span3">
				...
				<a href="rooms.html"><img
					src="web-resources/css/images/rooms.jpg" alt="" /></a>
			...
			<div class="span3">
				...
				<a href="map.html"><img
					src="web-resources/css/images/location.jpg" alt="" /></a>
				...
				<div class="span4">
					...
					<p class="copy">
						All content &copy; 2013 <a
							href="../../../www.appsarea.com/index.html">AppsArea</a>
					</p>
