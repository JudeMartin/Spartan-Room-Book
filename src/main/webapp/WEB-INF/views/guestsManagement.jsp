...
<div style="padding-right:10px">
  ...
  <table class="table table-bordered table-striped">
      ...
      <tbody>
          ...
          <tr>
              <td>
                  <c:out value="${guest.last_name}"/> <c:out value="${guest.first_name}"/>
                  <a href="#"><img src="web-resources/css/images/eye.png" alt="Edit" width="20" height="20" onClick="getGuestDetails(${guest.guest_id})" align="right"/></a>
              </td></hr>
          </tr>
         </c:forEach>
    ...
    <div class="span4">
            <form class="form-inline mini">
                <div class="row">
                    <div class="span3">
                        <h4>
                        <div id="blanket" style="display:none; top: 150px;"></div>
                        <div id="popUpDiv" style="display:none; padding:5px; top: 150px">
                        ...
                        <div id="guestInfoView" class="row">
                        ...
                        <div id="stayInfoView" class="row">
                            ...
                            <div class="span3 ">
                                <div class="control-group">
                                    <label for="focusedInput" class="control-label">Adults</label>
                                    <div class="controls">
                                        <label for="focusedInput" class="control-label"></label>                            </div>
                                </div>
                            </div>
...
<footer>
	...
	<script type="text/javascript"
		src='<c:url value="/web-resources/js/js-for-listGuests.js"/>'></script>
