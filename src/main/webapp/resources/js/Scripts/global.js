	...
	$('.book-start .datepicker_to').datepicker(
			{
				...
				minDate : 1,
				onClose : function(selectedDate) {
					$('.book-start .datepicker_to').datepicker("option",
...
function update_extras_price() {
	var base_price = JSON.stringify(localStorage.getItem("base_price"));
	var b = base_price.slice(1, base_price.length);
	var formattedBasePrice = base_price.slice(2, base_price.length - 4);
	var numberBase = Number(formattedBasePrice);

	var extras = $('input:checked').length;
	var extras_price = (extras * 15);
	localStorage.setItem("extras_price", extras_price);
	var total_price = numberBase + extras_price;

	var localBasePrice = base_price.slice(2, base_price.length - 4);
	localStorage.setItem("localBasePrice", localBasePrice);
...
function update_total_price() {
	...
	$('#base_price').text("$" + total_price.toFixed(2));
	$('#base_price').html("$" + total_price.toFixed(2));
	localStorage.setItem("base_price", total_price);
...
function initialize_map() {
	 ...
	 * new google.maps.Size(42,62), new google.maps.Point(0,0), new
	 * google.maps.Point(21,62) );
	 */
